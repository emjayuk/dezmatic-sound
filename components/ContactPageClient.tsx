...
import { LocationIcon, ClockIcon, MusicIcon } from '@/components/icons/EventIcons'
...
const INFO_ROWS: InfoRow[] = [
  { icon: <LocationIcon />, text: 'Bristol, UK — Available nationwide & internationally' },
  { icon: <ClockIcon />, text: 'We typically respond within a few hours' },
  { icon: <MusicIcon />, text: 'Weddings · Club Nights · Carnivals · Corporate · Private Hire' },
]
          ...
          >
            ...
            <div className="w-full mt-6 flex flex-col gap-4">
              {INFO_ROWS.map((row) => (
                ...
                >
                  <span style={{ color: 'var(--color-blue)', flexShrink: 0, marginTop: '2px' }}>
                    {row.icon}
                  </span>
                  <span
